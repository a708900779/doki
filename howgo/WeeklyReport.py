...
DATA_PATH = "../data/howgo数据/周报/天猫数据1102.xls"
...
jgl = (df_main['商品加购件数'] / df_main['商品访客数']).apply(lambda x: f"{x:.2%}")
...
# 2. 从后往前插入以保证顺序正确
df_main.insert(insert_pos, '30天加购率',np.nan)
df_main.insert(insert_pos, '7天加购率',jgl)
